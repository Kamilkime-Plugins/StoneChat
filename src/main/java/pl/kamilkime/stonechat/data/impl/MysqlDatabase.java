...
public class MysqlDatabase extends Database {
    ...
    private static final String SAVE_USER = "INSERT INTO {TABLE} VALUES (?, ?, ?) ON DUPLICATE KEY UPDATE stone_mined = ?, " +
            "next_message_time = ?;";

    public MysqlDatabase(final HikariDataSource dataSource, final Plugin plugin, final String tableName) {
